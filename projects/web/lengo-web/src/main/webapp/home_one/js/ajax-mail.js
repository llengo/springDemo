...
$(function () {
    ...
    $(".form-button").click(function () {
        ...
        var dataString = 'userName=' + name + '&userEmail=' + email + '&content=' + message;
        //alert (dataString);return false;

        var url = $("#af-form").attr("action");
        $.ajax({
            type:"POST",
            url:url,
            data:dataString,
            success:function () {
                $('#af-form').prepend("<div class=\"alert alert-success fade in\"><button class=\"close\" data-dismiss=\"alert\" type=\"button\">&times;</button><strong>Your message was sent! </strong> We will get back at You soon</div>");
                $('#af-form')[0].reset();
            }
        });
        return false;
