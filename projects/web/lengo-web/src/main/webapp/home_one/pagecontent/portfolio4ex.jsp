        ...
        <div class="page-header">
            <div class="row">
                <div class="span8">
                    ...
                    <div><a class="node_click_a" href="javascript:void(0)" pnode="pnode_one" action="<%=basePath%>home/index">Home</a> &nbsp;&rsaquo;&nbsp; Portfolio 4 Column Extended</div>
                </div>
