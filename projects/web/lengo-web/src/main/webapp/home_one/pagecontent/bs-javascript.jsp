...
<section class="breadcrumbs">
    <div class="container">
        <div class="page-header">
            <div class="row">
                <div class="span8">
                    <h1>Bootstrap <small>/ JavaScript</small></h1>
                    <div><a class="node_click_a" href="javascript:void(0)" pnode="pnode_one" action="<%=basePath%>home/index">Home</a> &nbsp;&rsaquo;&nbsp; JavaScript</div>
                </div>
...
<div class="bs-docs-example docs-example" style="background-color: #f5f5f5;">
...
<div class="bs-docs-example docs-example" style="padding-bottom: 24px;">
...
<section id="tooltips">
    ...
    <div class="bs-docs-example docs-example tooltip-demo">
...
<section id="popovers">
    ...
    <div class="bs-docs-example docs-example bs-docs-example docs-example-popover">
