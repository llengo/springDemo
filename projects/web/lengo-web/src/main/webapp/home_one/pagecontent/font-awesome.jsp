        ...
        <div class="page-header">
            <div class="row">
                <div class="span8">
                    ...
                    <div><a class="node_click_a" href="javascript:void(0)" pnode="pnode_one" action="<%=basePath%>home/index">Home</a> &nbsp;&rsaquo;&nbsp; FontAwesome</div>
                </div>
    ...
    <div class="row">
        <div class="span4">
            ...
            <ul class="unstyled">
                ...
                <li style="height: 40px;"><span class="square bg-color-green-dark"></span>*-color-green-dark</li>
                <li style="height: 40px;"><span class="square bg-color-green-light"></span>*-color-green-light</li>
                <li style="height: 40px;"><span class="square bg-color-pink"></span>*-color-pink</li>
                <li style="height: 40px;"><span class="square bg-color-pink-dark"></span>*-color-pink-dark</li>
            </ul>
        </div>
        <div class="span4">
            <h2>&nbsp;</h2>
            <ul class="unstyled">
                ...
                <li style="height: 40px;"><span class="square bg-color-blue-dark"></span>*-color-blue-dark</li>
            </ul>
        </div>
        <div class="span4">
            <h2>&nbsp;</h2>
            <ul class="unstyled">
                <li style="height: 40px;"><span class="square bg-color-blue-light"></span>*-color-blue-light</li>
                <li style="height: 40px;"><span class="square bg-color-orange"></span>*-color-orange</li>
                <li style="height: 40px;"><span class="square bg-color-orange-dark"></span>*-color-orange-dark</li>
