...
public class SendMail {
	...
	public static void main(String[] args) throws MessagingException, IOException{
    	...
    	//success
    	//SendMail mail = new SendMail("604450235@qq.com","etxbmefyqlhxbbji");
    	//map.put("mail.smtp.host", "smtp.qq.com");
    	
    	//success
    	SendMail mail = new SendMail("iwo1024@163.com","****system****");
    	map.put("mail.smtp.host", "smtp.163.com");
    	
//    	SendMail mail = new SendMail("hyc_happy_everyday@163.com","*****");
//    	map.put("mail.smtp.host", "smtp.163.com");
    	//暂时未成功，需要调试
