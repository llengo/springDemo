 ...
 * 
 * @ClassName: MyDes 
 * @Description: des加密工具（可与web端js互转） 
 *  
 * @author 船长
 * @date 2016年11月4日 上午11:43:43
 */
public class MyDes {
	public MyDes() {}
	 ...
	 * @Description: 加密
	 * @param data 要加密的字符串
	 * @param firstKey 自定义key1（必填，默认为0）
	 * @return    返回加密字符串
	 * @throws 
	 * @date 2016年11月4日 上午11:42:10  
	 * @author 船长
	 */
	public static String encrypt(String data, String firstKey) {
		return encrypt(data, firstKey, null);
	}
	/**
	 * 
	 * @Title: 加密
	 ...
	 * @param data 要加密的字符串
	 * @param firstKey 自定义key1（必填，默认为0）
	 * @param secondKey 自定义key2
	 * @return    返回加密字符串
	 * @throws 
	 * @date 2016年11月4日 上午11:41:15  
	 * @author 船长
	 */
	 ...
	 * @param firstKey 自定义key1（必填，默认为0）
	 * @param secondKey 自定义key2
	 * @param thirdKey 自定义key3
	 * @return    返回加密字符串
	 * @throws 
	 * @date 2016年11月4日 上午11:42:14  
	 * @author 船长
	 */
	 ...
	 * @return    设定文件 
	 * @throws 
	 * @date 2016年11月4日 上午11:46:59  
	 * @author 船长
	 */
	public static String decrypt(String data, String firstKey) {
		return decrypt(data, firstKey, null);
	}
	/**
	 * 
	 * @Title: decrypt 
	...
	public static void main(String[] args) {
		String data = "admin";
		String str = encrypt(data,"1","2","3");
		System.out.println(str);
		String dec = decrypt(str,"1","2","3");
